...
public final class JackOLanternLightModel extends LightModel {
	...
	public JackOLanternLightModel() {
		AdvancedRendererModel pumpkin = new AdvancedRendererModel(this, 28, 42);
		...
		AdvancedRendererModel leaf1 = new AdvancedRendererModel(this, 12, 18);
		...
		AdvancedRendererModel leaf2 = new AdvancedRendererModel(this, 12, 18);
		...
		AdvancedRendererModel stem = new AdvancedRendererModel(this, 21, 41);
		stem.setRotationPoint(0, 2, 0);
		stem.addBox(-1, 0, -1, 2, 2, 2, 0);
		stem.setRotationAngles(Mth.PI, 0, 0);
		amutachromicParts.addChild(stem);
		AdvancedRendererModel face = new AdvancedRendererModel(this, 56, 34);
