...
public class LetterBuntingConnectionModel extends ConnectionModel<LetterBuntingConnection> {
	...
	@Override
	public void renderTexturePass(Fastener<?> fastener, LetterBuntingConnection letterBunting, World world, int skylight, int moonlight, float delta) {
	...
	@Override
	protected void renderSegment(LetterBuntingConnection connection, int index, double angleX, double angleY, double length, double x, double y, double z, float delta) {
