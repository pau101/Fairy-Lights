...
public class JackOLanternLightModel extends ColorLightModel {
    public JackOLanternLightModel() {
        ...
        pumpkin.setAngles(FLMath.PI, 0.0F, 0.0F);
        ...
        vec.func_229194_d_();
        final Quaternion droop = vec.func_229193_c_(FLMath.PI / 12.0F);
        ...
        final Quaternion q = Vector3f.field_229181_d_.func_229193_c_(FLMath.PI);
        ...
        face.field_78795_f = FLMath.PI;
        face.field_78796_g = FLMath.PI;
