...
public class IcicleLightsModel extends LightModel {
    public IcicleLightsModel(final int lights) {
        ...
        connector.addCuboid(-1, -0.5F, -1, 2, 2, 2, -0.05F);
        ...
        if (lights > 0) {
            ...
            wire1.addCuboid(-0.5F, 0, -0.5F, 1, 4, 1, 0);
            ...
            lightBase1.addCuboid(-0.5F, 0, 0, 1, 1, 1, 0);
            ...
            light1.addCuboid(-1, -0.5F, 0, 2, 2, 2, 0);
        ...
        if (lights > 1) {
            ...
            wire2.addCuboid(-0.5F, 0, -0.5F, 1, 4, 1, 0);
            ...
            lightBase2.addCuboid(-0.5F, 0, 0, 1, 1, 1, 0);
            ...
            light2.addCuboid(-1, -0.5F, 0, 2, 2, 2, 0);
        ...
        if (lights > 2) {
            ...
            wire3.addCuboid(-0.5F, 0, -0.5F, 1, 4, 1, 0);
            ...
            lightBase3.addCuboid(-0.5F, 0, 0, 1, 1, 1, 0);
            ...
            light3.addCuboid(-1, -0.5F, 0, 2, 2, 2, 0);
        ...
        if (lights > 3) {
            ...
            wire4.addCuboid(-0.5F, 0.0F, -0.5F, 1, 4, 1, 0.0F);
            ...
            lightBase4.addCuboid(-0.5F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
            ...
            light4.addCuboid(0.0F, 0.0F, 0.0F, 2, 2, 2, 0.0F);
