...
public class OrnateLanternModel extends LightModel {
    public OrnateLanternModel() {
        this.unlit.setTextureOffset(21, 0);
        this.unlit.addCuboid(-1, 0.5F, -1, 2, 1, 2, -0.05F);
        this.unlit.setTextureOffset(0, 3);
        this.unlit.addCuboid(-1.5F, -1.5F, -1.5F, 3, 2, 3);
        this.unlit.setTextureOffset(43, 15);
        this.unlit.addCuboid(-2.5F, -1.75F, -2.5F, 5, 1, 5);
        this.unlit.setTextureOffset(23, 27);
        this.unlit.addCuboid(-3, -2.5F, -3, 6, 1, 6);
        this.unlit.setTextureOffset(43, 21);
        this.unlit.addCuboid(-2.5F, -8.5F, -2.5F, 5, 1, 5);
        for (int i = 0; i < 4; i++) {
            final ModelRenderer frame = new ModelRenderer(this, 4 * i + 47, 27);
            frame.addCuboid(-0.5F, 0, -0.5F, 1, 6, 1);
        ...
        bulb.setUV(48, 6);
        bulb.addCuboid(-2, -7.5F, -2, 4, 5, 4, 0.0F, 0.2F);
    }
}
