...
public class SnowflakeLightModel extends LightModel {
    public SnowflakeLightModel() {
        ...
        connector.addCuboid(-1.0F, 0.2F, -1.0F, 2.0F, 1.0F, 2.0F, -0.05F);
        ...
        for (int n = 0; n < branches; n++) {
            ...
            branch.addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, size, 1.0F, rng.nextFloat() * 0.01F + 0.1F);
            ...
            for (int side = -1; side <= 1; side += 2) {
                ...
                sub.addCuboid(-0.5F, 0.0F, -0.5F, 1.0F, size * 0.4F, 1.0F, rng.nextFloat() * 0.01F - 0.05F);
