...
public final class LadderModel extends EntityModel<LadderEntity> {
    ...
    public LadderModel() {
        ...
        spreaderLeft.addCuboid(-0.5F, -1.0F, 0.0F, 1, 2, 14, 0.0F);
        ...
        railRearLeft.addCuboid(-1.0F, -45.0F, -1.0F, 2, 45, 2, 0.0F);
        ...
        railFrontRight.addCuboid(-1.0F, -45.0F, -1.5F, 2, 45, 3, 0.0F);
        ...
        railFrontLeft.addCuboid(-1.0F, -45.0F, -1.5F, 2, 45, 3, 0.0F);
        ...
        railRearRight.addCuboid(-1.0F, -45.0F, -1.0F, 2, 45, 2, 0.0F);
        ...
        rod3.addCuboid(-6.5F, -0.5F, -0.5F, 13, 1, 1, 0.0F);
        ...
        rod4.addCuboid(-6.5F, -0.5F, -0.5F, 13, 1, 1, 0.0F);
        ...
        spreaderRight.addCuboid(-0.5F, -1.0F, 0.0F, 1, 2, 14, 0.0F);
        this.root.addChild(spreaderRight);
    }

    @Override
    public void setAngles(final LadderEntity ladder, final float limbSwing, final float limbSwingAmount, final float ticks, final float yaw, final float pitch) {
    }
