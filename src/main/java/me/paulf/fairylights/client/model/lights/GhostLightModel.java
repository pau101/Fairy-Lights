...
public final class GhostLightModel extends LightModel {
    ...
    public GhostLightModel() {
        final AdvancedRendererModel bodyTop = new AdvancedRendererModel(this, 52, 48);
        bodyTop.setRotationPoint(0, 2, 0);
        bodyTop.addBox(-1.5F, 0, -1.5F, 3, 1, 3, 0);
        bodyTop.setRotationAngles(Mth.PI, 0, 0);
        this.colorableParts.addChild(bodyTop);
        final AdvancedRendererModel littleFace = new AdvancedRendererModel(this, 40, 17);
        littleFace.setRotationPoint(0, -1, -2.25F);
        littleFace.addBox(-1.5F, -1.5F, 0, 3, 3, 0, 0);
        littleFace.setRotationAngles(Mth.PI, 0, 0);
        this.amutachromicParts.addChild(littleFace);
        final AdvancedRendererModel body = new AdvancedRendererModel(this, 46, 40);
        body.setRotationPoint(0, 1, 0);
        body.addBox(-2, 0, -2, 4, 4, 4, 0);
        body.setRotationAngles(Mth.PI, 0, 0);
        this.colorableParts.addChild(body);
        final int finCount = 8;
        for (int i = 0; i < finCount; i++) {
            final AdvancedRendererModel fin = new AdvancedRendererModel(this, 40, 21);
            ...
            this.colorableParts.addChild(fin);
        }
    }
