...
public final class FenceFastenerRenderer extends EntityRenderer<FenceFastenerEntity> {
	...
	public FenceFastenerRenderer(EntityRendererManager mgr) {
		super(mgr);
		model = new FastenerModel();
	}

	@Override
	public void doRender(FenceFastenerEntity fastener, double x, double y, double z, float yaw, float delta) {
	...
	@Override
	protected ResourceLocation getEntityTexture(FenceFastenerEntity entity) {
