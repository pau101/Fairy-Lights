...
public class ListRegularIngredient implements RegularIngredient {
	...
	public ListRegularIngredient(RegularIngredient... ingredients) {
		this(Arrays.asList(ingredients));
	}

	public ListRegularIngredient(List<RegularIngredient> ingredients) {
	...
	public final GenericRecipe.MatchResultRegular matches(ItemStack input, ItemStack output) {
		...
		for (RegularIngredient ingredient : ingredients) {
