...
public class LadderItem extends Item {
    ...
    public ActionResultType onItemUse(final ItemUseContext context) {
        ...
        if (!world.hasNoCollisions(FLEntities.LADDER.get().func_220328_a(x, y, z))) {
            return ActionResultType.FAIL;
        }
        if (!world.isRemote) {
            ...
            world.playSound(null, ladder.getPosX(), ladder.getPosY(), ladder.getPosZ(), FLSounds.LADDER_PLACE.get(), ladder.getSoundCategory(), 0.75F, 0.8F);
        }
        heldStack.shrink(1);
