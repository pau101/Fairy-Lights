...
public final class InteractionConnectionMessage extends ConnectionMessage<Connection> {
	...
	public static void serialize(InteractionConnectionMessage message, PacketBuffer buf) {
	...
	public static InteractionConnectionMessage deserialize(PacketBuffer buf) {
		InteractionConnectionMessage message = new InteractionConnectionMessage();
	...
	public static final class Handler implements BiConsumer<InteractionConnectionMessage, Supplier<NetworkEvent.Context>> {
		...
		private void handle(InteractionConnectionMessage message, NetworkEvent.Context context) {
