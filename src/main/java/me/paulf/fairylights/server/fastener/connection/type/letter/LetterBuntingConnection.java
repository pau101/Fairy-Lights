...
public final class LetterBuntingConnection extends Connection implements Lettered {
	...
	public LetterBuntingConnection(World world, Fastener<?> fastener, UUID uuid, Fastener<?> destination, boolean isOrigin, CompoundNBT compound) {
		super(world, fastener, uuid, destination, isOrigin, compound);
	}

	public LetterBuntingConnection(World world, Fastener<?> fastener, UUID uuid) {
