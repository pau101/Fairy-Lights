...
public final class Mat4d {
	...
	public Vec3d transform(Vec3d point) {
		...
		return new Vec3d(
			m00 * point.xCoord + m01 * point.yCoord + m02 * point.zCoord + m03,
			m10 * point.xCoord + m11 * point.yCoord + m12 * point.zCoord + m13,
			m20 * point.xCoord + m21 * point.yCoord + m22 * point.zCoord + m23
		);
	}
}
