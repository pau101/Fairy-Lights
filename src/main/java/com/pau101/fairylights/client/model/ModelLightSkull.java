...
public class ModelLightSkull extends ModelLight {
	public ModelLightSkull() {
		...
		apertures.setRotationAngles(MathUtils.PI, 0, 0);
		...
		skull.setRotationAngles(MathUtils.PI, 0, 0);
		...
		mandible.setRotationAngles(MathUtils.PI / 16 + MathUtils.PI, MathUtils.PI, 0);
		...
		maxilla.setRotationAngles(MathUtils.PI, 0, 0);
		...
		chain.setRotationAngles(MathUtils.PI, 0, 0);
